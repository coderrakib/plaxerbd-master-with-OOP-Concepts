          ...
          <div class="col-md-8 offset-md-2 ftco-animate">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="appointment_email" class="text-black">New Password <span class="text-danger">*</span></label>
                  <input type="password" id="pass" class="form-control">
                </div>
                <div class="form-group">
                  <button type="button" onclick="sendEmail()" value="Change" class="btn btn-primary">Change</button>
                </div>
              </form>
              </div>
            </div> 
